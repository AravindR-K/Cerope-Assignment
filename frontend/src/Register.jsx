...
if (res.data.status === 200) {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-[#fff] via-[#fafafa] to-[#f3f3f3]">

      {/* NAVBAR */}
      <header className="flex justify-between items-center px-10 py-4 border-b bg-white/30 backdrop-blur-md">
      ...
      <section className="flex justify-center items-start gap-20 py-16">
        ...
        {/* LEFT SIDE FORM */}
        <div className="w-[400px] bg-white/70 backdrop-blur-md shadow-lg rounded-xl p-8">
          <h2 className="text-2xl font-bold mb-6">Set up Your Cerope Account</h2>
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              className="w-full py-2 bg-black text-white rounded-full mt-2 hover:bg-gray-800 transition"
            >
              Sign Up
            </button>
